...
\newpage
    ...
    \MainTitleBis{\ColorHighlight}{\ColorTextMain}{What I bring to the table}{\faInfo} 
    	{
	    	\begin{itemize}
        ...
        \MainTitleBis{\ColorHighlight}{\ColorTextMain}{What I am looking for}{\faSearch}
    	{
	    	\begin{itemize}
